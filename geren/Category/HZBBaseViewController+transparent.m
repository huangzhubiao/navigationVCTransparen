//
//  HZBBaseViewController+transparent.m
//  geren
//
...
@implementation HZBBaseViewController (transparent)
//定义常量 必须是C语言字符串
...
- (void)setNavBarBgAlpha:(NSString *)navBarBgAlpha {
    ...
    [(HZBNaviViewController *)self.navigationController setNeedsNavigationBackground:[navBarBgAlpha floatValue]];
}
